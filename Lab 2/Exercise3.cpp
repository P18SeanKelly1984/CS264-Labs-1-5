...
{	
   ...
   //unsigned numbers aka positive values
   ...
   for( i = 0 ; i < n; i++ ) 
     {
    	...
    	//% 6 will produce a number between 1 and 6
    	//rand produces a value between 0 and int max?
	    dice1 = rand() % 6 + 1;
	    dice2 = rand() % 6 + 1; 
	...
	for(i = 0; i < 11; i++)
	  {
		  //+2 when dice combined total is a min of 2
